export const exercises = [
...

    {
        ...
        descricao: "Mova a torre de a1 para a8.",
...

    {
        id: 4,
        tema: "pecas",
        nome: "Bispo na diagonal",
        descricao: "Mova o bispo de c1 para g5.",
        fen: "4k3/8/8/8/8/8/8/2B1K3 w - - 0 1",
        moves: [
            { from: "c1", to: "g5" }
        ],
...

    {
        ...
        fen: "8/4k3/8/5P2/8/8/8/6K1 w - - 0 1",
        moves: [
            { from: "f5", to: "f6" }
        ],
        pontos: 15
...

    {
        ...
        fen: "8/4k3/5n2/8/8/8/8/4K3 w - - 0 1",
        moves: [
            { from: "c1", to: "g5" }
        ],
        pontos: 20
...

    {
        ...
        descricao: "Mova o bispo de d3 para c2, revelando o ataque da torre à dama.",
...

    {
        ...
        fen: "8/8/3k4/3n4/3q4/2N5/8/6K1 w - - 0 1",
        moves: [
            { from: "c3", to: "b5" }
        ],
        pontos: 20
...

    {
        ...
        fen: "4k3/8/8/1B6/4P3/5N2/P7/4K3 b - - 0 1",
        moves: [
            { from: "a7", to: "a6" }
        ],
        pontos: 25
...

    {
        ...
        descricao: "Depois de 1.e4 e5 2.Cf3 Cc6 3.Bc4, desenvolva o cavalo para f6.",
        fen: "4k3/8/2n5/4p3/2B1P3/5N2/8/4K3 b - - 0 1",
        moves: [
            { from: "g8", to: "f6" }
        ],
        pontos: 25
...

    {
        ...
        fen: "4k3/8/8/3p4/2PP4/8/4P3/4K3 b - - 0 1",
        moves: [
            { from: "e7", to: "e6" }
        ],
        pontos: 25
...

    {
        ...
        descricao: "Depois de 1.d4 Cf6 2.c4 g6, desenvolva o cavalo para c3.",
        fen: "4k3/8/6p1/8/2PP4/8/8/4K1N1 w - - 0 1",
        moves: [
            { from: "g1", to: "f3" }
        ],
        pontos: 25
